...
require([
    'router', 'h5-api', 'h5-price', 'h5-view', 'h5-touchsliderBanner', 'mydate', 'iscrollLoading', 'h5-login-judge', 'touch-slide',
    'filters', 'h5-weixin', 'hchart'
], function (router, api, price, View, touchsliderBanner, mydate, iscrollLoading, loginJudge) {
                ...
                yAxis: {
                    ...
                    tickInterval: (function () {
                        if ((max - min).toFixed(2) <= 0.01) {
                            return (max - min) * 10000000 * 0.9 / 10000000 < 0.01 ? 0.01 : (max - min) * 10000000 * 0.9 / 10000000;
                        } else if ((max - min).toFixed(2) < 0.08) {
                            return (max - min) * 10000000 * 0.5 / 10000000 < 0.01 ? 0.01 : (max - min) * 10000000 * 0.5 / 10000000;
                        } else {
                            return (max - min) * 10000000 * 0.3 / 10000000 < 0.01 ? 0.01 : (max - min) * 10000000 * 0.3 / 10000000;
                        }
                    })(),
                    labels: {
                        formatter: function () {
