...
require(['h5-api', 'check', 'router', 'h5-view', 'h5-check', 'h5-ident', 'h5-text', 'h5-alert', 'h5-paypass', 'h5-weixin','h5-view-agreement','h5-keyboard'], function(api, check, router, View, h5Check, h5Ident) {
