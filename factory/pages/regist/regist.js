...
require(['h5-api', 'check', 'router', 'h5-view', 'h5-check', 'h5-ident', 'h5-text', 'h5-alert', 'h5-paypass', 'h5-weixin','h5-view-agreement','h5-component-keyboard'], function(api, check, router, View, h5Check, h5Ident) {
	...
	var vm = avalon.define({
		...
		paypass2Next: function() {
			...
			if (vm.ifPaypass2Next && check.paypassCondition(value)) {
