...
// H5微信端 --- 我的
define('h5-view-address-wallet', ['router', 'h5-api', 'h5-view', 'check', 'h5-alert', 'h5-text', 'h5-component-keyboard'], function(router, api, View, check) {
